...
public class EncryptionDecryptionController {
	...
	@DeleteMapping(value = {"/encryptmsgs/{id}"})
	public String deleteEncryptDataById(@PathVariable("id") Integer id) {
		String result = encryptionDecryptionService.deleteEncryptDataById(id);
		return result;
	}
